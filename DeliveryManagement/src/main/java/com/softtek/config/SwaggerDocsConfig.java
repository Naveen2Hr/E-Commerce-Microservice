...
public class SwaggerDocsConfig {
	...
	private ApiInfo getApiInfo() {
		Contact contact = new Contact("Softtek", "https://www.softtek.com", "delivery.help@softtek.com");
		return new ApiInfo("Delivery API ", " Information About Online Shopping Delivery", "5.5.Release",
